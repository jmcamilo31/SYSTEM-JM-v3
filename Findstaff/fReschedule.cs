...
namespace Findstaff
{
    public partial class fReschedule : Form
    {
        ...
        private void fReschedule_Load(object sender, EventArgs e)
        {
        ...
        {
            DialogResult y = MessageBox.Show("Are you sure you want to reschedule?", "Reschedule Flight?", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
